...
public class UsuarioService {
	...
	public Optional<Usuario> atualizarUsuario(Usuario usuario) {
		...
		/**
		 * Retorna para a Classe UsuarioController o objeto Atualizado no Banco de Dados
		 * A Classe controladora checará se deu tudo certo nesta operação
		 * 
		 */
		return Optional.of(usuarioRepository.save(usuario));
	...
	public Optional<UsuarioLogin> autenticarUsuario(Optional<UsuarioLogin> usuarioLogin) {
		...
		/**
		 * Se ocorrer algum erro ou alguma condição não for satisfeita, o método retornará null
		 */
		return null;
	}
