...
public class ProdutoController {
	...
	public ResponseEntity <Produto> GetByNomeLaboratorio(@PathVariable String nome, @PathVariable String laboratorio){
		return produtoRepository.findByNomeAndLaboratorio(nome, laboratorio)
